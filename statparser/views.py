...
INTERVENTIONS = ["ABX","AMINOG", "ANTICOAG", "CARBA", "CODE", "DIGOXIN", "DRUGS", "ELECTROLYT", "FOLLOWUP", "INSULIN", "LITHIUM", "MONITOR", "PAIN", "PHENOBARB", "PRADAXA", "REGIONAL", "RIVAROXABA", "SENTOUT", "THEOPHYL", "TPN", "VALPROIC", "VANCO", "WARFARIN", "WEIGHT"]
